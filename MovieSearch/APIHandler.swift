...
class APIHandler{
   ...
   static let search_base_API = "https://api.themoviedb.org/3/search/movie?"
   static let discover_base_API = "https://api.themoviedb.org/3/discover/movie?api_key=fd7995a0d018c59d9076191bef81645c&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1"
    static let api_key = "fd7995a0d018c59d9076191bef81645c"
    static let image_base_API = "https://image.tmdb.org/t/p/w342/"
